/**
 * Компонент заполнения данных заявителя
 * 
 * FSD: features/fill-client-info/ui - UI компонент для заполнения данных заявителя
 */
...
/**
 * Компонент для заполнения данных заявителя
 * Поддерживает 4 типа заявителей: физ.лица, юр.лица, ИП, гос.органы
 */
