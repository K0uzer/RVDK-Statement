 ...
 * 
 * FSD: entities/request/api - API методы для заявок
 */

import axios, { AxiosError, AxiosInstance } from 'axios'
import { config } from '@/shared/config'
import type { ServiceT } from '@/entities/service'
import type { AccordionT, RequestFormData } from '@/entities/request'
 ...
 * 
 * - baseURL: берётся из конфигурации
 ...
 * Использование: import { api } from '@/entities/request/api'; await api.getProvidingServices()
 */
export const api = {
    /**
